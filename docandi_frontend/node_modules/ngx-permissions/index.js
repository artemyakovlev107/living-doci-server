...
import { catchError, every, first, map, mergeAll, mergeMap, skip, switchMap, tap } from 'rxjs/operators';
...
var NgxPermissionsConfigurationService = /** @class */ (function () {
     ...
     * @return {?}
     */
    NgxPermissionsConfigurationService.prototype.predefinedStrategy = /**
     * @param {?} strategy
     * @return {?}
     */
    function (strategy) {
...
var NgxPermissionsDirective = /** @class */ (function () {
    ...
    function () {
        ...
        return merge(this.permissionsService.permissions$, this.rolesService.roles$)
            ...
            if (notEmptyValue(_this.ngxPermissionsExcept)) {
                return _this.validateExceptAndOnlyPermissions();
            }
            if (notEmptyValue(_this.ngxPermissionsOnly)) {
                return _this.validateOnlyPermissions();
            }
        ...
        if (!isBoolean(this.currentAuthorizedState) || this.currentAuthorizedState) {
            ...
            if (this.unauthorisedStrategyDefined()) {
                if (isString(this.unauthorisedStrategyDefined())) {
                    ...
                    (/** @type {?} */ (this.unauthorisedStrategyDefined()))(this.templateRef);
                }
                return;
            }
        ...
        if (!isBoolean(this.currentAuthorizedState) || !this.currentAuthorizedState) {
            ...
            if (this.onlyAuthorisedStrategyDefined()) {
                if (isString(this.onlyAuthorisedStrategyDefined())) {
                    ...
                    this.showTemplateBlockInView(this.templateRef);
                    (/** @type {?} */ (this.onlyAuthorisedStrategyDefined()))(this.templateRef);
                }
                return;
            }
     ...
     * @return {?}
     */
    NgxPermissionsDirective.prototype.noElseBlockDefined = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxPermissionsDirective.prototype.noThenBlockDefined = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxPermissionsDirective.prototype.onlyAuthorisedStrategyDefined = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxPermissionsDirective.prototype.unauthorisedStrategyDefined = /**
     * @return {?}
     */
    function () {
